...
const EditProductModal: React.FC<EditProductProps> = ({
	...
	const [selectedGenres, setSelectedGenres] = useState<number[]>(
		product.genres?.map((genre) => genre.id) || []
	)
	...
	return (
		<div className="fixed inset-0 z-50 bg-black bg-opacity-50 flex items-center justify-center animate__animated animate__fadeIn">
			...
			<div
				className="bg-primaryBlack-default text-white p-8 rounded-2xl shadow-lg w-full max-w-4xl max-h-[90vh] overflow-y-auto transform transition-all duration-300 animate-fadeInScale"
